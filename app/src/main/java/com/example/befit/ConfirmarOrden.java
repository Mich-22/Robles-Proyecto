...
public class ConfirmarOrden extends AppCompatActivity {
                ...
                if(task.isSuccessful()){
                    FirebaseDatabase.getInstance().getReference().child("Carrito")
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(ConfirmarOrden.this, "Tu orden fue tomada con exito", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(ConfirmarOrden.this, PrincipalActivity.class);
